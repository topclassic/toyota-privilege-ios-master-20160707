...
class HistoryController: UIViewController, UIWebViewDelegate, UIScrollViewDelegate {
...
//            self.showAlertTest("Phone Number", message: input)
    ...
    func loadAddress(){
        ...
        urlString = "\(urlString)&request_page=history"
//        print("History url = \(urlString)")
        Util().userDefaults.setObject(urlString, forKey: "currentUrl")
//        showAlertTest("History Tab Url", message: urlString)
